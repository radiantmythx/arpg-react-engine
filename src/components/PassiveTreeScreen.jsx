...
const STAT_LABELS = {
  ...
  flatBlazeDamage:      (v) => `+${v} Flat Blaze Damage`,
  flatThunderDamage:    (v) => `+${v} Flat Thunder Damage`,
  flatFrostDamage:      (v) => `+${v} Flat Frost Damage`,
  flatPhysicalDamage:   (v) => `+${v} Flat Physical Damage`,
  flatHolyDamage:       (v) => `+${v} Flat Holy Damage`,
  flatUnholyDamage:     (v) => `+${v} Flat Unholy Damage`,
  increasedBlazeDamage:    (v) => `+${Math.round(v*100)}% Increased Blaze Damage`,
  increasedThunderDamage:  (v) => `+${Math.round(v*100)}% Increased Thunder Damage`,
  increasedFrostDamage:    (v) => `+${Math.round(v*100)}% Increased Frost Damage`,
  ...
  blazeResistance:      (v) => `+${Math.round(v*100)}% Blaze Resistance`,
  thunderResistance:    (v) => `+${Math.round(v*100)}% Thunder Resistance`,
