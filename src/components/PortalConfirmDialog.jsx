export function PortalConfirmDialog({ portalsRemaining = 0, isFree = false, onConfirm, onCancel }) {
  return (
    <div className="overlay portal-confirm-overlay">
      <div className="portal-confirm-panel">
        ...
        {isFree ? (
          <>
            <p className="portal-confirm-copy">
              Return to the Hub now?
            </p>
            <p className="portal-confirm-subcopy portal-confirm-subcopy--free">
              The boss has been defeated — this portal is free.
            </p>
          </>
        ) : (
          <>
        ...
        <div className="portal-confirm-actions">
          <button className="btn btn-primary" onClick={onConfirm}>{isFree ? 'Yes, Return to Hub' : 'Yes, Use Portal'}</button>
